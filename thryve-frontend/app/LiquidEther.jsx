  ...
  useEffect(() => {
    ...
    class CommonClass {
      ...
      init(container) {
        ...
        canvas.style.inset = "0"; // top:0; right:0; bottom:0; left:0
        canvas.style.width = "100%";
        canvas.style.height = "100%";
        canvas.style.display = "block";
        canvas.style.zIndex = "0";
        canvas.style.pointerEvents = "none"; // never block your UI (events will bubble to the container)
